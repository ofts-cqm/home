...
:::: columns flex="4 6"
::: column
![Ascendance Foundry](../ascendance.jpeg)
:::
...
:::: grid columns=3
::: flip-card title="Unity Based Minecraft" image="../minecraft_unity.png" alt="Unity Based Minecraft terrain" languages="C Sharp, Unity"
...
::: flip-card title="Minecraft Skin Animator" image="../mcgif.png" alt="Minecraft Skin Animator" languages="React, JavaScript, Java, Kotlin, Ktor, JavaFx, MySql"
...
::: flip-card title="Linear Algebra Calculator" image="../matcalc.png" alt="Linear Algebra Calculator" languages="Qt, cpp, QML, Json"
...
::: flip-card title="Video Game Modding" image="../mods.png" alt="Video Game Modding" languages="C Sharp, Java, Forge, SMAPI, IL Spy"
...
::: flip-card title="Android Todo App" image="../wattodo.png" alt="Android Todo App" languages="Java, Kotlin, Android Studio, Python, Flask, MySql, RestApi"
...
::: flip-card title="C Compiler" image="../compiler.png" alt="C Compiler" languages="C Sharp"
